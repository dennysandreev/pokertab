...
### Buttons
- **Primary:** Emerald Green background with white text. High contrast for "Join Table" or "Deposit".
- **Secondary:** Dark grey (#252525) with white text. For "Settings" or "History".
- **Ghost:** No background, white or slate text. For "Back" or "Cancel".
